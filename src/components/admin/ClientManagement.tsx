...
export function ClientManagement({ companyId }: ClientManagementProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success("Cliente criado com sucesso! O usuário já pode fazer login com as credenciais fornecidas.");
      ...
      {clients.length === 0 ? (
        <div className="bg-white rounded-lg shadow p-8 text-center">
          ...
          <p className="text-gray-600 mb-4">
            Comece criando seu primeiro cliente para gerenciar chamados de serviço.
          </p>
          <button
            onClick={() => setShowCreateModal(true)}
