  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await createServiceOrder({
        serviceType: "laudo",
        description: formData.description || "Solicitação de laudo técnico",
      ...
      toast.success("Solicitação de laudo enviada com sucesso");
      ...
      <div className="bg-white rounded-lg shadow p-6">
        <div className="mb-6">
          ...
          <p className="text-gray-600">
            Preencha os dados abaixo para solicitar um novo laudo técnico
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-green-50 p-6 rounded-lg">
            ...
            <p className="text-sm text-green-700 mb-4">
              Informe os dados necessários para solicitar um novo laudo técnico
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500"
                  placeholder="Endereço completo onde será realizado o laudo"
                  required
                />
              </div>
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500"
                  placeholder="Informações adicionais sobre o laudo (opcional)"
                />
              </div>
            </div>
          </div>
